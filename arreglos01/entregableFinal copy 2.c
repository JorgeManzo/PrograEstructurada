...
int main() {
    ...
    do{
        printf("%sIngresa las coordenadas de %s",jugadores[0], barcosJ1[0]);
        scanf("%d" "%d", &a, &b);
    ...
    do{
        printf("%sIngresa las coordenadas de %s",jugadores[1], barcosJ2[0]);
        scanf("%d" "%d", &a2, &b2);
    ...
    do {
        ...
        }else if (tablero2[fila][columna] == 4)//Evalua en 4 porque ese es el valor de los barcos 2x2
        {
            ...
            printf("\nYa hab%cas disparado en esta coordenada.", 161);
            turno=1;
        }
